...
import LogoDark from "../../images/logo/logo-farizal-pet-shop.png";
import Logo from "../../images/logo/logo-farizal-pet-shop.png";

const SignIn: React.FC = () => {
  // State for password input and show/hide
  const [password, setPassword] = useState("");
  const [showPassword, setShowPassword] = useState(false);

  return (
    <>
      <div className="xl:flex xl:items-center xl:justify-center xl:min-h-screen xl:w-full md:w-[700px] md:mx-auto sm:grid sm:h-dvh sm:items-center">
        <div className="bg-white flex flex-wrap items-center md:h-auto h-screen">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center place-self-center">
              ...
              <p className="2xl">Aplikasi Pengelolaan Toko Farizal Pet Shop</p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <div className="flex flex-col place-self-center text-center items-center mb-5.5 inline-block xl:hidden">
                <img
                  className="hidden dark:block"
                  src={Logo}
                  alt="Logo"
                ...
                />
                <p className="2xl">
                  Aplikasi Pengelolaan Toko Farizal Pet Shop
                </p>
              </div>
                      ...
                      {password === "" ? (
                        ...
                        >
                          {showPassword ? (
                            ...
                            <g opacity="0.5">
                              <path
                                d="M11 4C6 4 2.73 7.11 1 11C2.73 14.89 6 18 11 18C16 18 19.27 14.89 21 11C19.27 7.11 16 4 11 4ZM11 16C7.13 16 4.06 13.36 2.35 11C4.06 8.64 7.13 6 11 6C14.87 6 17.94 8.64 19.65 11C17.94 13.36 14.87 16 11 16ZM11 8C9.34 8 8 9.34 8 11C8 12.66 9.34 14 11 14C12.66 14 14 12.66 14 11C14 9.34 12.66 8 11 8ZM11 12C10.45 12 10 11.55 10 11C10 10.45 10.45 10 11 10C11.55 10 12 10.45 12 11C12 11.55 11.55 12 11 12Z"
                                fill=""
                              />
                            </g>
                          ) : (
                            ...
                            <g opacity="0.5">
                              <path
                                d="M11 4C6 4 2.73 7.11 1 11C2.73 14.89 6 18 11 18C16 18 19.27 14.89 21 11C19.27 7.11 16 4 11 4ZM11 16C7.13 16 4.06 13.36 2.35 11C4.06 8.64 7.13 6 11 6C14.87 6 17.94 8.64 19.65 11C17.94 13.36 14.87 16 11 16ZM11 8C9.34 8 8 9.34 8 11C8 12.66 9.34 14 11 14C12.66 14 14 12.66 14 11C14 9.34 12.66 8 11 8ZM4.41 4.86L3 6.27L7.73 11H8C8 12.66 9.34 14 11 14C11.37 14 11.72 13.94 12.05 13.84L15.73 17.52L17.14 16.11L4.41 4.86Z"
                                fill=""
                              />
                            </g>
                          )}
